...
from lib.pvtv1 import pvt_medium
import os
import torch
import torch.nn as nn
import torch.nn.functional as F
...
class PanaricPVT(nn.Module):
    def __init__(self, channel=32):
        super(PanaricPVT, self).__init__()

        self.backbone = pvt_medium()  # [64, 128, 320, 512]
        path = './pretrained_pth/pvt_medium.pth'
        ...
        self.out_SAM = nn.Conv2d(channel*2, 1, 1)
    ...
    def forward(self, x):
        ...
        prediction2 = self.out_SAM(torch.cat((cfm_feature, T2),1))
